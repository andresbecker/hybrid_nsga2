...
set xrange [ 0 : 202 ] noreverse nowriteback

#GRAFICA DE PUNTOS
plot 'igd_g.dat' using 1:7:xticlabel(8) with points lc "red" lw 2 title 'NSGA-II HIBRIDO', 'igd_o.dat' using 1:7 with points lc "black" lw 2 title 'NSGA-II ORIGINAL'
