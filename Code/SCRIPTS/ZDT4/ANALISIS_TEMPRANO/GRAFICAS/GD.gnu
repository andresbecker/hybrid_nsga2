...
set samples 800, 800 
set title "{/=15 GD con p=2 y 30 Ejecuciones para ZDT6}"
set ylabel "{/=13 GD}" 
...
#GRAFICA DE PUNTOS
plot 'gd_g.dat' using 1:7 with points lc "red" lw 2 title 'NSGA-II HIBRIDO', 'gd_o.dat' using 1:7 with points lc "black" lw 2 title 'NSGA-II ORIGINAL'
