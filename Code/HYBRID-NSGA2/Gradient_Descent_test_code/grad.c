...
/*
	This file contains the development code for applying gradient descent
	for some random individuals of the population.

	Comment added on 23.09.2020

	Developed by Andres Becker
*/
