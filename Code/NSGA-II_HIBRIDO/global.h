...
/*VARIABLES DEFINIDAS PARA METODO DEL GRADIENTE*/
extern int eval;
extern int eval_nsga2;
extern int eval_grad;
extern int maxiter;
extern int gen_grad;
extern double epsilon;
extern double h;
extern double alfa_max; 
extern double c1;
extern double **gradiente;
extern double *direccion;
...
/*FUNCIONES PARA EL METODO DEL GRADIENTE*/
void grad(individual *ind);
/*void test_problem (double *xreal, double *obj);*/
